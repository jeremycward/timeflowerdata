...
- `/home/runner/work/timeflowerdata/timeflowerdata/timelineschema.json` — source JSON Schema
- `/home/runner/work/timeflowerdata/timeflowerdata/python/generate_pydantic_models.py` — build script that generates Python (Pydantic) artifacts from the schema
...
```bash
python /home/runner/work/timeflowerdata/timeflowerdata/python/generate_pydantic_models.py
```
